...
"""Build the DT1_8_POLY_OSC firmware image from YOUR copy of the official OS 1.53 file.
    ...
    python3 tools/build.py --official <official OS 1.53 .syx> --tool <path to container tool> [--out out/]
...
RELEASE      = "v3p"
VERSION_TAG  = "1.5b"                     # what the unit shows
...
PATCHED_S3   = "3b1258bc7556ebb42898120fa2c0f759da6a2e5fb759db96ab9d33a837ddab53"
PATCHED_SYX  = "f8cd0d721c265a07077078a5aae95908c265ce3fadd0c83cbbb377916b51b8b3"   # with the tool version used
...
def main():
    ...
    with tempfile.TemporaryDirectory() as t:
        ...
        run([sys.executable, os.path.join(HERE, "patch_section3.py"), s3, patched])
